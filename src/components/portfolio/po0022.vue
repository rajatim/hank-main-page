  ...
  data() {
    return {
      infors: {
        ...
        urlName: "App建置中",
        // url: "http://yaprecious.com/",
        webName: "SimpleMart APP",
        skill: "UI/UX Design---使用工具 Illustrator/Figma",
        infor:
          "Do something and get something when you attempt to complete a particular action. ",
        pic: "./static/images/simplesmart.jpg",
        link: "/appdesign"
      }
    };
  }
